...
class RoomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $rooms = $em->getRepository('SporFonyBundle:Room')->findAll();
    ...
    {
        $room = new Room();
        $form = $this->createForm('SporFonyBundle\Form\RoomType', $room);
    ...
    {
        $deleteForm = $this->createDeleteForm($room);
        $editForm = $this->createForm('SporFonyBundle\Form\RoomType', $room);
